...
[RosyREDCap](https://github.com/thecodingdocs/RosyREDCap) stands out by
offering comprehensive extraction of all metadata and data from any
REDCap project into a standardized R list object, facilitating
effortless downstream use in exports, imports, transformation, and
applications. This is showcased in the exploratory data analysis shiny
app included in the package. The three core aims of
[RosyREDCap](https://github.com/thecodingdocs/RosyREDCap) are to…
...
using the [remotes](https://remotes.r-lib.org) package. Be sure to
install [remotes](https://remotes.r-lib.org) if you don’t have it
already.
...
0.0.0.9005. You can check what version you have installed with the
following.
...
[![TheCodingDocs.com](reference/figures/TCD.png)](http://www.thecodingdocs.com)
